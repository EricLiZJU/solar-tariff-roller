...
def run_calculation(payload: CalculationInput) -> dict:
    ...
    return {
        ...
        "monthly_irr": result.monthly_irr,
        "historical_months_count": result.historical_months_count,
        ...
        "monthly_projections": [
            {
                ...
                "annualized_revenue_basis_10k_cny": row.annualized_revenue_basis_10k_cny,
                "insurance_cost_10k_cny": row.insurance_cost_10k_cny,
                "om_cost_10k_cny": row.om_cost_10k_cny,
                "replacement_cost_10k_cny": row.replacement_cost_10k_cny,
                "total_cost_10k_cny": row.total_cost_10k_cny,
                "input_vat_10k_cny": row.input_vat_10k_cny,
                "output_vat_10k_cny": row.output_vat_10k_cny,
                "vat_balance_10k_cny": row.vat_balance_10k_cny,
            ...
            for row in result.monthly_projections
        ],
        "annual_projections": [
            {
                "year": row.year,
                ...
                "annual_rent_10k_cny": row.annual_rent_10k_cny,
                "annual_om_10k_cny": row.annual_om_10k_cny,
                ...
                "input_vat_10k_cny": row.input_vat_10k_cny,
                "output_vat_10k_cny": row.output_vat_10k_cny,
                "annual_vat_balance_10k_cny": row.annual_vat_balance_10k_cny,
                "vat_payable_10k_cny": row.vat_payable_10k_cny,
                "vat_credit_carry_10k_cny": row.vat_credit_carry_10k_cny,
                "surcharge_tax_10k_cny": row.surcharge_tax_10k_cny,
                "net_cashflow_10k_cny": row.net_cashflow_10k_cny,
